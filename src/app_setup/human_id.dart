...
// Docker, starting from 0.7.x, generates names from notable scientists and
// hackers. Please, for any amazing man that you add to the list, consider
// adding an equally amazing woman to it, and vice versa.
...
// telephone - https://en.wikipedia.org/wiki/Alexander_Graham_Bell
  "bell",
...
// Bhaskara II - Ancient Indian mathematician-astronomer whose work on calculus
// predates Newton and Leibniz by over half a millennium -
...
// Anita Borg - Anita Borg was the founding director of the Institute for Women
// and Technology (IWT). https://en.wikipedia.org/wiki/Anita_Borg
  "borg",
...
// Evelyn Boyd Granville - She was one of the first African-American woman to
// receive a Ph.D. in mathematics; she earned it in 1949 from Yale University.
...
// Emmett Brown invented time travel. https://en.wikipedia.org/wiki/Emmett_Brown
// (thanks Brian Goff)
  "brown",

// Rachel Carson - American marine biologist and conservationist, her book
// Silent Spring and other writings are credited with advancing the global
// environmental movement. https://en.wikipedia.org/wiki/Rachel_Carson
  "carson",

// Subrahmanyan Chandrasekhar - Astrophysicist known for his mathematical theory
// on different stages and evolution in structures of the stars. He has won
// nobel prize for physics -
// https://en.wikipedia.org/wiki/Subrahmanyan_Chandrasekhar
  "chandrasekhar",

//Claude Shannon - The father of information theory and founder of digital
//circuit design theory. (https://en.wikipedia.org/wiki/Claude_Shannon)
  "shannon",

// Joan Clarke - Bletchley Park code breaker during the Second World War who
// pioneered techniques that remained top secret for decades. Also an
// accomplished numismatist https://en.wikipedia.org/wiki/Joan_Clarke
  "clarke",

// Jane Colden - American botanist widely considered the first female American
// botanist - https://en.wikipedia.org/wiki/Jane_Colden
  "colden",

// Gerty Theresa Cori - American biochemist who became the third woman—and first
// American woman—to win a Nobel Prize in science, and the first woman to be
// awarded the Nobel Prize in Physiology or Medicine. Cori was born in Prague.
// https://en.wikipedia.org/wiki/Gerty_Cori
  "cori",

// Seymour Roger Cray was an American electrical engineer and supercomputer
// architect who designed a series of computers that were the fastest in the
// world for decades. https://en.wikipedia.org/wiki/Seymour_Cray
  "cray",

// This entry reflects a husband and wife team who worked together: Joan Curran
// was a Welsh scientist who developed radar and invented chaff, a radar
// countermeasure. https://en.wikipedia.org/wiki/Joan_Curran Samuel Curran was
// an Irish physicist who worked alongside his wife during WWII and invented the
...
// Donna Dubinsky - played an integral role in the development of personal
// digital assistants (PDAs) serving as CEO of Palm, Inc. and co-founding
...
// for the Centaur rocket stage and one of the first African-Americans in her
...
// Gertrude Elion - American biochemist, pharmacologist and the 1988 recipient
// of the Nobel Prize in Medicine - https://en.wikipedia.org/wiki/Gertrude_Elion
  "elion",
...
// Richard Feynman was a key contributor to quantum mechanics and particle
// physics. https://en.wikipedia.org/wiki/Richard_Feynman
  "feynman",
...
// Galileo was a founding father of modern astronomy, and faced politics and
// obscurantism to establish scientific truth.
...
// Adele Goldberg, was one of the designers and developers of the Smalltalk
// language. https://en.wikipedia.org/wiki/Adele_Goldberg_(computer_scientist)
  "goldberg",

// Adele Goldstine, born Adele Katz, wrote the complete technical description
// for the first electronic digital computer, ENIAC.
// https://en.wikipedia.org/wiki/Adele_Goldstine
  "goldstine",

// Shafi Goldwasser is a computer scientist known for creating theoretical
// foundations of modern cryptography. Winner of 2012 ACM Turing Award.
...
// Jane Goodall - British primatologist, ethologist, and anthropologist who is
...
// Grete Hermann was a German philosopher noted for her philosophical work on
// the foundations of quantum mechanics.
// https://en.wikipedia.org/wiki/Grete_Hermann
  "hermann",

// Jaroslav Heyrovský was the inventor of the polarographic method, father of
// the electroanalytical method, and recipient of the Nobel Prize in 1959. His
// main field of work was polarography.
// https://en.wikipedia.org/wiki/Jaroslav_Heyrovsk%C3%BD
  "heyrovsky",

// Dorothy Hodgkin was a British biochemist, credited with the development of
// protein crystallography. She was awarded the Nobel Prize in Chemistry in
// 1964. https://en.wikipedia.org/wiki/Dorothy_Hodgkin
  "hodgkin",

// Erna Schneider Hoover revolutionized modern communication by inventing a
// computerized telephone switching method.
...
// and  is credited with popularizing the term "debugging" for fixing computer
// glitches. https://en.wikipedia.org/wiki/Grace_Hopper
  "hopper",

// Frances Hugle, she was an American scientist, engineer, and inventor who
// contributed to the understanding of semiconductors, integrated circuitry, and
// the unique electrical principles of microscopic materials.
// https://en.wikipedia.org/wiki/Frances_Hugle
  "hugle",

// Hypatia - Greek Alexandrine Neoplatonist philosopher in Egypt who was one of
// the earliest mothers of mathematics - https://en.wikipedia.org/wiki/Hypatia
  "hypatia",
...
// Mary Lou Jepsen, was the founder and chief technology officer of One Laptop
// Per Child (OLPC), and the founder of Pixel Qi.
// https://en.wikipedia.org/wiki/Mary_Lou_Jepsen
  "jepsen",

// Katherine Coleman Goble Johnson - American physicist and mathematician
// contributed to the NASA. https://en.wikipedia.org/wiki/Katherine_Johnson
  "johnson",

// Irène Joliot-Curie - French scientist who was awarded the Nobel Prize for
// Chemistry in 1935. Daughter of Marie and Pierre Curie.
...
// which is used in most search engines today.
// https://en.wikipedia.org/wiki/Karen_Sp%C3%A4rck_Jones
  "jones",

// A. P. J. Abdul Kalam - is an Indian scientist aka Missile Man of India for
...
// Susan Kare, created the icons and many of the interface elements for the
// original Apple Macintosh in the 1980s, and was an original employee of NeXT,
// working as the Creative Director. https://en.wikipedia.org/wiki/Susan_Kare
  "kare",

// Mary Kenneth Keller, Sister Mary Kenneth Keller became the first American
// woman to earn a PhD in Computer Science in 1965.
// https://en.wikipedia.org/wiki/Mary_Kenneth_Keller
  "keller",

// Har Gobind Khorana - Indian-American biochemist who shared the 1968 Nobel
// Prize for Physiology - https://en.wikipedia.org/wiki/Har_Gobind_Khorana
  "khorana",

// Jack Kilby invented silicone integrated circuits and gave Silicon Valley its
// name. - https://en.wikipedia.org/wiki/Jack_Kilby
  "kilby",
...
// Donald Knuth - American computer scientist, author of "The Art of Computer
// Programming" and creator of the TeX typesetting system.
...
// Marie-Jeanne de Lalande - French astronomer, mathematician and cataloguer of
// stars - https://en.wikipedia.org/wiki/Marie-Jeanne_de_Lalande
  "lalande",
...
// Leslie B. Lamport - American computer scientist. Lamport is best known for
// his seminal work in distributed systems and was the winner of the 2013 Turing
...
// Proconsul skull - https://en.wikipedia.org/wiki/Mary_Leakey
  "leakey",

// Henrietta Swan Leavitt - she was an American astronomer who discovered the
// relation between the luminosity and the period of Cepheid variable stars.
// https://en.wikipedia.org/wiki/Henrietta_Swan_Leavitt
  "leavitt",

//Daniel Lewin -  Mathematician, Akamai co-founder, soldier, 9/11 victim--
//Developed optimization techniques for routing traffic on the internet. Died
//attempting to stop the 9-11 hijackers.
...
// Barbara Liskov - co-developed the Liskov substitution principle. Liskov was
// also the winner of the Turing Prize in 2008. -
...
// Mahavira - Ancient Indian mathematician during 9th century AD who discovered
// basic algebraic identities -
// https://en.wikipedia.org/wiki/Mah%C4%81v%C4%ABra_(mathematician)
  "mahavira",

// Maria Mayer - American theoretical physicist and Nobel laureate in Physics
...
// Barbara McClintock - a distinguished American cytogeneticist, 1983 Nobel
// Laureate in Physiology or Medicine for discovering transposons.
...
// of nuclear fission. The element meitnerium is named after her -
// https://en.wikipedia.org/wiki/Lise_Meitner
  "meitner",

// Carla Meninsky, was the game designer and programmer for Atari 2600 games
// Dodge 'Em and Warlords. https://en.wikipedia.org/wiki/Carla_Meninsky
  "meninsky",

// Johanna Mestorf - German prehistoric archaeologist and first female museum
// director in Germany - https://en.wikipedia.org/wiki/Johanna_Mestorf
  "mestorf",

// Marvin Minsky - Pioneer in Artificial Intelligence, co-founder of the MIT's
// AI Lab, won the Turing Award in 1969.
// https://en.wikipedia.org/wiki/Marvin_Minsky
  "minsky",

// Maryam Mirzakhani - an Iranian mathematician and the first woman to win the
// Fields Medal. https://en.wikipedia.org/wiki/Maryam_Mirzakhani
  "mirzakhani",

// Samuel Morse - contributed to the invention of a single-wire telegraph system
// based on European telegraphs and was a co-developer of the Morse code -
...
// Florence Nightingale, more prominently known as a nurse, was also the first
// female member of the Royal Statistical Society and a pioneer in statistical
// graphics
...
// Poppy Northcutt. Poppy Northcutt was the first woman to work as part of
// NASA’s Mission Control.
// http://www.businessinsider.com/poppy-northcutt-helped-apollo-astronauts-2014-12?op=1
  "northcutt",

// Robert Noyce invented silicone integrated circuits and gave Silicon Valley
// its name. - https://en.wikipedia.org/wiki/Robert_Noyce
  "noyce",

// Panini - Ancient Indian linguist and grammarian from 4th century CE who
// worked on the world's first formal system -
...
// proposed in her Ph.D. thesis an explanation for the composition of stars in
// terms of the relative abundances of hydrogen and helium.
// https://en.wikipedia.org/wiki/Cecilia_Payne-Gaposchkin
  "payne",

// Radia Perlman is a software designer and network engineer and most famous for
// her invention of the spanning-tree protocol (STP).
// https://en.wikipedia.org/wiki/Radia_Perlman
  "perlman",

// Rob Pike was a key contributor to Unix, Plan 9, the X graphic system, utf-8,
// and the Go programming language. https://en.wikipedia.org/wiki/Rob_Pike
  "pike",
...
// Laura Poitras is a director and producer whose work, made possible by open
// source crypto tools, advances the causes of truth and freedom of information
// by reporting disclosures by whistleblowers such as Edward Snowden.
...
// C. V. Raman - Indian physicist who won the Nobel Prize in 1930 for proposing
// the Raman effect. - https://en.wikipedia.org/wiki/C._V._Raman
  "raman",
...
// Sally Kristen Ride was an American physicist and astronaut. She was the first
// American woman in space, and the youngest American astronaut.
...
// research was critical to the understanding of DNA -
...
// symbolic manipulation of mathematical formulas.
// https://en.wikipedia.org/wiki/Jean_E._Sammet
  "sammet",

// Carol Shaw - Originally an Atari employee, Carol Shaw is said to be the first
// female video game designer.
// https://en.wikipedia.org/wiki/Carol_Shaw_(video_game_designer)
  "shaw",

// Dame Stephanie "Steve" Shirley - Founded a software company in 1962 employing
// women working from home. https://en.wikipedia.org/wiki/Steve_Shirley
  "shirley",
...
// Françoise Barré-Sinoussi - French virologist and Nobel Prize Laureate in
// Physiology or Medicine; her work was fundamental in identifying HIV as the
// cause of AIDS.
...
// Richard Matthew Stallman - the founder of the Free Software movement, the GNU
// project, the Free Software Foundation, and the League for Programming
// Freedom. He also invented the concept of copyleft to protect the ideals of
// this movement, and enshrined this concept in the widely-used GPL (General
// Public License) for software. https://en.wikiquote.org/wiki/Richard_Stallman
  "stallman",

// Michael Stonebraker is a database research pioneer and architect of Ingres,
// Postgres, VoltDB and SciDB. Winner of 2014 ACM Turing Award.
// https://en.wikipedia.org/wiki/Michael_Stonebraker
  "stonebraker",

// Janese Swanson (with others) developed the first of the Carmen Sandiego
// games. She went on to found Girl Tech.
...
// freedom of information on the web. https://en.wikiquote.org/wiki/Aaron_Swartz
  "swartz",

// Bertha Swirles was a theoretical physicist who made a number of contributions
// to early quantum theory. https://en.wikipedia.org/wiki/Bertha_Swirles
  "swirles",

// Nikola Tesla invented the AC electric system and every gadget ever used by a
// James Bond villain. https://en.wikipedia.org/wiki/Nikola_Tesla
  "tesla",
...
// Varahamihira - Ancient Indian mathematician who discovered trigonometric
// formulae during 505-587 CE -
...
// recipient of the Indian Republic's highest honour, the Bharat Ratna, in 1955.
// On his birthday, 15 September is celebrated as Engineer's Day in India in his
// memory - https://en.wikipedia.org/wiki/Visvesvaraya
  "visvesvaraya",

// Christiane Nüsslein-Volhard - German biologist, won Nobel Prize in Physiology
// or Medicine in 1995 for research on the genetic control of embryonic
...
// Sophie Wilson designed the first Acorn Micro-Computer and the instruction set
// for ARM processors. https://en.wikipedia.org/wiki/Sophie_Wilson
  "wilson",
...
// physicist, and a co-winner of the 1977 Nobel Prize in Physiology or Medicine
// for development of the radioimmunoassay technique.
// https://en.wikipedia.org/wiki/Rosalyn_Sussman_Yalow
  "yalow",

// Ada Yonath - an Israeli crystallographer, the first woman from the Middle
// East to win a Nobel prize in the sciences.
// https://en.wikipedia.org/wiki/Ada_Yonath
  "yonath",
];

/// GetRandomName generates a random name from the list of adjectives and
/// surnames in this package formatted as "adjective_surname". For example
/// 'focused_turing'. If withInteger is true, a random integer between 0 and 10
/// will be added to the end of the name, e.g `focused_turing3`
String getRandomName([bool withInteger = false]) {
  var rand = math.Random();
  var name = _generate(rand);

  while (name == "boring_wozniak") {
    name = _generate(rand); // Steve Wozniak is not boring
  }

  if (withInteger) {
    name = "$name${rand.nextInt(10)}";
  }

  return name;
}

String _generate(math.Random r) => "${_left[r.nextInt(_left.length)]}${_right[r.nextInt(_right.length)]}";
